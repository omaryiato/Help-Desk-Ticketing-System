...
if (isset($_POST['notassignedteam'])) {   // Choose Service Details Debends On Service Type
...
if (isset($_POST['teamMembers'])) {   // Choose Team Member Based On Team Number
...
if (isset($_POST['selectDetailsTeamMember'])) {   // Select Details Team Member Based On Service Details Name
