            ...
            <ul class="navbar-nav  d-flex w-100 justify-content-endtext-light">
                ...
                <li class="nav-item">
                    ...
                    <ul class="tran">
                        ...
                        <li><a href="?action=team" aria-label="Go To The User Orders"><i class="fa-solid fa-users pe-2"></i>Team Member</a></li>
                        <li><a href="?action=new" aria-label="Logout From User Account"><i class="fa-solid fa-plus pe-2"></i>New Tickets</a></li>
                        <li><a href="?action=service" aria-label="Logout From User Account"><i class="fa-solid fa-headphones pe-2"></i>Services</a></li>
                        <li><a href="?action=delegate" aria-label="Logout From User Account"><i class="fa-solid fa-user-minus pe-2"></i>Delegate Supervisors</a></li>
