...
if (isset($_SESSION['employee'])) {
    header('Location: ticket.php');  // Redirect To Home Page
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($numRows > 0) {
        $_SESSION['employee'] = $username; // Register Session Name
        $_SESSION['ID'] = $row['ID'];  // Register Session ID
        header('Location: ticket.php'); // Redirect To Dashboard Page
        exit();
    }
}
...
<!-- Login Form For User Side Start -->
