<nav class="navbar navbar-expand-lg bg-primary text-light">
    <div class="container">
        ...
        ?>
        <a class="navbar-brand text-light" href="TicketTransaction.phpp" id="refreshTicketTransation">e-Ticketing System</a>
        ...
        <div class="collapse navbar-collapse text-light" id="navbarNavDropdown">
            <ul class="navbar-nav  d-flex w-100 justify-content-endtext-light">
                ...
                <li class="nav-item">
                    ...
                    <ul class="tran">
                        <li><a href="TicketTransaction.php" id="TicketTransationTable" aria-label="Go To The User Profile"><i class="fa-solid fa-ticket pe-2"></i>Ticketing Transactions</a></li>
